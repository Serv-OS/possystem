...
Migration: `20260919m_OPS_ezcater_menu_sync_v1.sql` (renamed: its first name clashed with a parked branch; `decided_as` added in review round 3; no schema change in round 4, keys are text), run AFTER ezcater-connect and ezcater-webhook are deployed, outside service, then press Sync.
