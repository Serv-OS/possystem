...
- IN FLIGHT: wf_2a8d676b (link_holder + Payouts and commission step). QUEUED: Card readers page rebuild (one venue list, rename, Add by serial, storeIds scoped inventory, Advanced collapsed). Peter's rule: the whole reader experience must be understandable by a venue owner.
