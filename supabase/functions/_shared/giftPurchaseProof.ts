...
// 000_baseline_platform.sql and the 20260907b PLATFORM file 2 draft), so status, amount_minor and
// the session ids on the row can be forged. The row is therefore NEVER the proof. The proof is
