...
//
// Keeps caller_authority_log from becoming an unbounded flood (18 Sep 2026, round three).
//
// Every refused or would-be refused call writes one row. Anybody with the public anon key can
...
// The insert itself is never awaited on the till path (loyalty-utils recordAuthority).
//
