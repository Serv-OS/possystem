...
// Limits, stated plainly: closed_checks inserts stay open to any session until the stage 1
// fence's Ops file B (20260919b) runs, so until then a determined attacker can still write a
// check row of their own to earn on.
...
/**
 * Where the earn comes from. `record` is a reason to write to the authority log.
