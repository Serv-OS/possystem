...
export const RATE_ROW_LABELS: Readonly<Record<string, string>> = Object.freeze({ card_present: 'In person', card_not_present: 'Online', amex: 'Amex and business cards', keyed: 'Keyed in' });
