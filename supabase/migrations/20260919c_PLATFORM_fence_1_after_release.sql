...
--      closing writes breaks nothing. Reading stays open for now ONLY because a Back
--      Office tab that has not reloaded since the release reads it with the anon key;
--      20260919d closes it.
...
-- Interim, removed by 20260919d: a Back Office tab from before the release reads with
-- the anon key.
...
-- gift_card_purchases_server ALL; reader_writable_by_browser = false;
