...
export default function PaymentCheckModal({ order, onClose, onSettled }) {
  ...
  return (
    <div onClick={onClose} style={{ position: 'fixed', inset: 0, zIndex: 1300, background: 'rgba(0,0,0,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div role="dialog" aria-label={PAYMENT_CHECKING_LABEL} onClick={e => e.stopPropagation()}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          <span style={{ fontSize: 10, fontWeight: 800, padding: '2px 8px', borderRadius: 8, background: '#f59e0b22', border: '1px solid #f59e0b66', color: '#b45309' }}>{PAYMENT_CHECKING_LABEL.toUpperCase()}</span>
