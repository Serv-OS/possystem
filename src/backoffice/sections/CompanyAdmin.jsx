...
export default function CompanyAdmin() {
  ...
  const createOrg = async () => {
    ...
    // 18 Sep 2026 (lockdown step 1): the company link is written by the server (profile-admin
    // claim_org: only a login with no company, only a brand new organisation nobody else is in).
    // The browser can no longer write user_profiles.org_id (it let a login claim other venues).
    try {
