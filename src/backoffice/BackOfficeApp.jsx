...
const NAV_IA = [
  ...
  { label:'Channels',   icon:'channels',  children:[['online','Online ordering'],['catering','Catering ordering'],['catering-orders','Catering orders'],['menu-appearance','Menu appearance'],['kiosks','Kiosks'],['menuboards','Menu boards']] },
