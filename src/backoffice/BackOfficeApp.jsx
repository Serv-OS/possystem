...
const NAV_IA = [
  ...
  { label:'Channels',   icon:'channels',  children:[['online','Online ordering'],['catering','Catering ordering'],['menu-appearance','Menu appearance'],['kiosks','Kiosks'],['menuboards','Menu boards']] },
