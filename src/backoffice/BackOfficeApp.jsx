...
import CustomerImport from './sections/CustomerImport';
...
const NAV = [
  ...
  { id:'customer-import', label:'Import customers', icon:'\u{1F4E5}', group:'Analytics' },
    ...
    <div style={{
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <div className="bo-page-shell">
          ...
          {section === 'customer-import' && <CustomerImport setSection={setSection} />}
