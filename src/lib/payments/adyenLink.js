...
const GOLIVE_TITLES = Object.freeze({
...
export function buildGoliveSteps(state = {}) {
  ...
  const step = (id, x) => ({ id, title: GOLIVE_TITLES[id], state: x.state, detail: x.detail, action: x.action ?? null, hint: x.hint ?? null });
  const out = [];
