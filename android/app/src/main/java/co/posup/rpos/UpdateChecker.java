...
/**
 * v1.3: In-app auto-updater for the sideloaded APK (no Play Store).
 *
 * Flow (per "auto-download + one-tap install"):
 ...
 *
 * latest.json shape (hosted at MANIFEST_URL):
 *   {
 *     "versionCode": 4,
 *     "versionName": "1.3",
 *     "apkUrl": "https://.../storage/v1/object/public/app-releases/app.apk",
 *     "mandatory": false,
 *     "notes": "what changed"
 *   }
 *
 * Release steps are in android/RELEASING.md.
 */
public class UpdateChecker {
    private static final String MANIFEST_URL =
        "https://tbetcegmszzotrwdtqhi.supabase.co/storage/v1/object/public/app-releases/latest.json";
    private static final long THROTTLE_MS = 3L * 60 * 60 * 1000; // re-check at most every 3h
    private static final String PREFS = "rpos_update";
    private static final String APK_NAME = "rpos-update.apk";
    ...
    private void beginUpdate(String apkUrl, String vName, boolean mandatory) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O
            ...
            AlertDialog.Builder b = new AlertDialog.Builder(activity)
                ...
                .setMessage("To keep the till up to date automatically, allow it to install "
    ...
    private void download(String apkUrl, String vName) {
        try {
            ...
            req.setTitle("Serv OS update" + (vName.isEmpty() ? "" : " " + vName));
