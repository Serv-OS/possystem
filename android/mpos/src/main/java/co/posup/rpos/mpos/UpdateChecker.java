...
/**
 * In-app auto-updater for the sideloaded MPOS APK (no Play Store).
 *
 * Flow (auto-download + one-tap install):
 *   on launch / resume (throttled)
 *     -> fetch latest-mpos.json from Supabase Storage
 ...
 * key (see android/RELEASING.md). The MPOS CI builds a fixed-key RELEASE APK for exactly
 * this reason.
 *
 * latest-mpos.json shape (hosted at MANIFEST_URL):
 *   { "versionCode": 2, "versionName": "1.1",
 *     "apkUrl": "https://.../storage/v1/object/public/app-releases/mpos.apk",
 *     "mandatory": false, "notes": "what changed" }
 */
public class UpdateChecker {
    private static final String MANIFEST_URL =
        "https://tbetcegmszzotrwdtqhi.supabase.co/storage/v1/object/public/app-releases/latest-mpos.json";
    private static final long THROTTLE_MS = 3L * 60 * 60 * 1000; // re-check at most every 3h
    private static final String PREFS = "mpos_update";
    private static final String APK_NAME = "mpos-update.apk";
    ...
    private void beginUpdate(String apkUrl, String vName, boolean mandatory) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O
            ...
            AlertDialog.Builder b = new AlertDialog.Builder(activity)
                ...
                .setMessage("To keep Serv OS MPOS up to date automatically, allow it to install "
    ...
    private void download(String apkUrl, String vName) {
        try {
            ...
            req.setTitle("Serv OS MPOS update" + (vName.isEmpty() ? "" : " " + vName));
